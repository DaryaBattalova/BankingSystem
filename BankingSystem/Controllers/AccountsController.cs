...
using BankingSystem.Models.Security;
...
namespace BankingSystem.Controllers
{
    ...
    public class AccountsController : ApiController
    {
        ...
        public AccountsController(ApplicationUserManager userManager, IEmailSendingService emailSendingService)
        {
        ...
        private async Task SendConfirmEmail(ApplicationUser user)
        {
            ...
            {
                Body = $"You have sucessfully registered in the best banking system. To confirm your account, please, follow this link: <a href='{GlobalInfo.ConfirmEmailUrl}?userId={ToBase64(user.Id)}&code={ToBase64(code)}'>link</a>",
